...
> Полный аудит и журнал: [audit-2026-09-full.md](./audit-2026-09-full.md)
...
- [ ] SEO-чек-лист — см. [SEO-чек-лист.md](./SEO-чек-лист.md) (контентные пункты)
...
> [deploy-prep-checklist.md](./deploy-prep-checklist.md)
...
- [ ] UFW/SSH/fail2ban на VPS — см. [security-hardening-checklist.md](./security-hardening-checklist.md)
...
См. [Контент-стратегия.md](./Контент-стратегия.md), [commercial-resource-roadmap.md](./commercial-resource-roadmap.md)
...
| Документ                                                 | Фаза        |
| -------------------------------------------------------- | ----------- |
| [architecture-reference.md](./architecture-reference.md) | Архитектура |
