...
> **Обновлено:** 2026-09-07 · журнал: [audit-2026-09-full.md](../audits/audit-2026-09-full.md) этапы 3–4
...
| Документ                                                               | Содержание       |
| ---------------------------------------------------------------------- | ---------------- |
| [testing-plan.md](../testing/testing-plan.md)                          | Playwright smoke |
| [architecture-reference.md](../architecture/architecture-reference.md) | `src/lib/`       |
