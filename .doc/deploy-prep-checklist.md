...
> **Связанные документы:** [server-vps-stack-plan.md](./server-vps-stack-plan.md), [testing-plan.md](./testing-plan.md), [project-roadmap.md](./project-roadmap.md)
...
Скопируйте в безопасное место (не в git!) — по шаблону [`.env.example`](../.env.example) и [forms.md](./forms.md):
...
- [ ] SSH hardening + fail2ban — см. [security-hardening-checklist.md](./security-hardening-checklist.md)
...
- [ ] Smoke-тест страниц — см. [testing-plan.md](./testing-plan.md)
...
- [ ] Финальный чеклист из [testing-plan.md](./testing-plan.md)
...
| [security-hardening-checklist.md](./security-hardening-checklist.md) | UFW, SSH, fail2ban, заголовки Caddy |
| [perimeter-edge-security.md](./perimeter-edge-security.md) | DNS, Cloudflare, миграция с Tilda |
| [forms.md](./forms.md) | Формы, `.env`, SMTP, Telegram |
| [testing-plan.md](./testing-plan.md) | Smoke-тесты и E2E |
| [project-roadmap.md](./project-roadmap.md) | Фаза 2: деплой на Beget VPS |
