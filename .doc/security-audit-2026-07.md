...
См. [perimeter-edge-security.md](./perimeter-edge-security.md) и [security-hardening-checklist.md](./security-hardening-checklist.md):
...
2. **Настроить VPS** по [perimeter-edge-security.md](./perimeter-edge-security.md) (§4.2).
...
| Документ | Содержание |
|---|---|
| [forms.md](./forms.md) | Формы: поля, эндпоинты, honeypot, rate-limit |
...
| [perimeter-edge-security.md](./perimeter-edge-security.md) | UFW, SSH, Cloudflare, DNS |
